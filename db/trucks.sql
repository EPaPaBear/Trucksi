...
--
-- Table structure for table `hystorytravel`
--

DROP TABLE IF EXISTS `hystorytravel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hystorytravel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `hystorytravel`
--
...
CREATE TABLE `truck` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `howmanypeople` int(2) DEFAULT NULL,
